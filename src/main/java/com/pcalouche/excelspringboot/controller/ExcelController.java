...
public class ExcelController {
    ...
    public ResponseEntity<byte[]> nonStreamingExcel() throws IOException {

        Long startTime = System.currentTimeMillis();
        logger.info("start of Non Streaming Excel request");

        NonStreamingExcelExport nonStreamingExcelExport = new NonStreamingExcelExport();
    ...
    public ResponseEntity<byte[]> streamingExcel() throws IOException {

        Long startTime = System.currentTimeMillis();
        logger.info("start of Streaming Excel request");

        StreamExcelExport streamExcelExport = new StreamExcelExport();
